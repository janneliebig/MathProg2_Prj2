...
# This will create a dataset with 1000 samples, where the samples form two interlocking circles. The X array will contain the feature coordinates, and the y array will contain the class labels (0 or 1).
class Cluster:
